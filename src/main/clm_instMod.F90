...
contains
  ...
  subroutine clm_instInit(bounds)
    ...
    use SoilBiogeochemDecompCascadeMIMICSplusMod, only : init_decompcascade_mimicsplus
    ...
    if_decomp: if (decomp_method /= no_soil_decomp) then
       ...
       if (decomp_method == mimicsplus_decomp ) then
          call cnfunmimicsplus_inst%Init(bounds,soilbiogeochem_carbonflux_inst,soilbiogeochem_nitrogenflux_inst)
       end if
