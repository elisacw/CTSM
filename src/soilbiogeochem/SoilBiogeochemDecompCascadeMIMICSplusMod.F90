module SoilBiogeochemDecompCascadeMIMICSplusMod
    ...
    !-------------------------------------WORK ON THIS--------------------------------
      ...
      subroutine init_decompcascade_mimicsplus(bounds, soilbiogeochem_state_inst, soilstate_inst )
        ...
        real(r8) :: mimicsplus_fphys_r_p1      ! B- Flux between MIC and SOMp? But why 4? there are only 2
        real(r8) :: mimicsplus_fphys_r_p2
        real(r8) :: mimicsplus_fphys_k_p1
        real(r8) :: mimicsplus_fphys_k_p2
        real(r8) :: mimicsplus_desorp_p1       ! B- Desorption from SOMp or SOMc to SOMa
          ...
          do c = bounds%begc, bounds%endc
             do j = 1, nlevdecomp
                ...
                fphys_m1(c,j) = dmin1(1.0_r8, mimicsplus_fphys_r_p1 * &
                                              dexp(mimicsplus_fphys_r_p2 * clay_frac))
                fphys_m2(c,j) = dmin1(1.0_r8, mimicsplus_fphys_k_p1 * &
                                              dexp(mimicsplus_fphys_k_p2 * clay_frac))
          ...
          do fc = 1,num_bgc_soilc
             ...
             do j = 1,nlevdecomp
                ...
                decomp_k(c,j,i_cop_mic) = tau_m1 * &
                       m1_conc**(mimicsplus_densdep - 1.0_r8) * w_d_o_scalars
                ...
                decomp_k(c,j,i_oli_mic) = tau_m2 * &
                       m2_conc**(mimicsplus_densdep - 1.0_r8) * w_d_o_scalars
